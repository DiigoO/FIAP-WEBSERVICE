...
public class ObjectFactory {
    ...
    private final static QName _Username_QNAME = new QName("http://ws2.exemplos.fiap.com/", "Username");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws2.exemplos.fiap.com/", name = "Username")
