 ...
 * 
 */
@WebServiceClient(name = "AlunoWebService", targetNamespace = "http://ws2.exemplos.fiap.com/", wsdlLocation = "http://l2901micro02:8080/Exemplo3/AlunoWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ALUNOWEBSERVICE_QNAME = new QName("http://ws2.exemplos.fiap.com/", "AlunoWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://l2901micro02:8080/Exemplo3/AlunoWebService?wsdl");
    ...
    public AlunoWeb getAlunoWebPort() {
        return super.getPort(new QName("http://ws2.exemplos.fiap.com/", "AlunoWebPort"), AlunoWeb.class);
    }
    ...
    public AlunoWeb getAlunoWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws2.exemplos.fiap.com/", "AlunoWebPort"), AlunoWeb.class, features);
    }
